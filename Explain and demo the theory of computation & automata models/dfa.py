    ...
    def process_input(self, input_string):
        ...
        for symbol in input_string:
            if symbol not in self.alphabet:
                raise ValueError(f"Input symbol {symbol} is not in alphabet.")
...
dfa = DFA(states, alphabet, start_state, accepting_states, transitions)

input_string = '0'
result = dfa.process_input(input_string)
print(f"The DFA {result} the string '{input_string}'")